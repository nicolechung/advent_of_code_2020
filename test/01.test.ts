import { pairs, threes, multiply, numbers, answer, followUp, SUM_TO } from '../src/01';

describe('Day one tests', () => {
  it('pairs finds two numbers that add up to 2020', () => {
    expect(pairs([1721, 979, 366, 299, 675, 1456], SUM_TO)).toEqual([1721, 299]);
  });
  it('threes finds three numbers that sum to 2020', () => {
    expect(threes([1721, 979, 366, 299, 675, 1456], SUM_TO)).toEqual([366, 675, 979]);
  });
